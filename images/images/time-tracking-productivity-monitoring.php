            ...
            <div class="swiper-slide home-bnr-screen ">
               ...
               <div class="cbox containerbox">
                  <div class="bnr-caption-box">
                     <h2 class="mt-3">Employee Time Tracking Software to Track Work Hours</h2>
                     <p class="subtitle">Helping organizations gain visibility of employee activities and track time worked, with actionable insights for individual &amp; teams</p>
                     ...
                     <div class="feature-row">
                        <div class="feature-item">
                           ...
                           <p class="feature-text">Automated work tracking software for desktop based workforce</p>
                        </div>
                  ...
                  <div class="ph-yt-vdo">
                     <a data-fancybox href="https://www.youtube.com/watch?v=X4ZBcXcPfhQ" class="">
                        ...
                        <img class="img-fluid" src="img/video-poster-phlp.png" alt="video ProHance">
                     </a>
                  </div>
               </div>
            </div>

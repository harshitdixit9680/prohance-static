...
<html lang="en">
   ...
   <body class="employee-tracking-container">
            ...
            <div class="swiper-slide home-bnr-screen ">
               ...
               <div class="cbox containerbox">
                  <div class="bnr-caption-box">
                     <h2 class="mt-3">No-code Workflow Platform Built With Inbuilt Process Mapping</h2>
                     <div class="feature-row">
                        <div class="feature-item">
                           <img src="images/workflow-design-process.png" alt="Design processes for automated work distribution" class="feature-icon">
                           <p class="feature-text">Design processes for automated work distribution</p>
                        </div>
                        <div class="feature-item">
                           <img src="images/workflow-task-management.png"alt="Automatically prioritize and allocate work using workflow task management"  class="feature-icon">
                           <p class="feature-text">Automatically prioritize and allocate work using workflow task management
                           </p>
                        </div>
                        <div class="feature-item">
                           <img src="images/workflow-manage-large-work.png" alt="Manage large work volume using online workflow management"  class="feature-icon">
                           <p class="feature-text">Manage large work volume using online workflow management
                           </p>
                        </div>
                        <div class="feature-item">
                           <img src="images/wflow-sla.png" alt="Ensure better SLA adherence and measure true productivity"  class="feature-icon">
                           <p class="feature-text">Ensure better SLA adherence and measure true productivity
                           </p>
                        </div>
                        <div class="feature-item">
                           <img src="images/wflow-greater-visibility.png"alt="Greater visibility and control in your workflow processes"  class="feature-icon">
                           <p class="feature-text">Greater visibility and control in your workflow processes
                           </p>
                        </div>
                        <div class="feature-item">
                           <img src="images/wflow-codeless-automation.png" alt="Codeless automation tool"  class="feature-icon">
                           <p class="feature-text">Codeless automation tool for workflow management
                           </p>
                        </div>
                     </div>
                  </div>
                  <div class="formhubSpot-box">
                     <div class="formhubSpot ">
                        <!--                         <span class="blob-bx tt-bnr-pic"><img src="images/t-t-p-m-i_1.png" alt="" width="98%" ></span>
                           -->
                        <h2 class="common-ttle text-center">Do You Want To Improve Your Internal Workflows And Reduce AHT?</h2>
                        ...
                        <script>
                           ...
                           region: "na1",
                           portalId: "8221763",
                           formId: "7422102c-3fba-41e5-a50a-eb05ac1ecc29"
                           });
                        </script>
                     </div>
                  </div>
                  <div class="ph-yt-vdo">
                     <a data-fancybox href="https://www.youtube.com/watch?v=fZSDVFun_3o" class="">
                        <!-- <div class="ellipse-1"></div>-->
                        <img class="img-fluid" src="images/workforce-ytube-video.png" alt="video ProHance">
                     </a>
                  </div>
               </div>
            </div>
                        ...
                        <div class="feature-column">
                           <div class="feature-card">
                              <div class="card-header">
                                 <img loading="lazy" src="https://www.prohance.net/new-lp/images/wf-healthcare.png" class="header-image" alt="Healthcare Drive Efficiencies in Coding Processes" />
                              </div>
                              <div class="card-content">
                                 <h3 class="card-title">Healthcare Drive Efficiencies in Coding Processes</h3>
                                 <div class="feature-item">
                                    ...
                                    <p class="feature-text">    Source work from multiple sources like emails, shared drives, excel uploads</p>
                                 </div>
                                 <div class="feature-item">
                                    ...
                                    <p class="feature-text">Track real-time status of work completion
                                    </p>
                                 </div>
                                 <div class="feature-item">
                                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/4481a0e347e34e4121bfef618f9d1079dee4c2445fb2fa975d55d311caf58014?apiKey=13afca4f450b492581b6852c1eaebe93&" class="feature-icon" alt="" />
                                    <p class="feature-text">Configure rules to auto allocate, prioritize and distribute work to multiple teams
                                    </p>
                                 </div>
                                 <div class="feature-item">
                                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/4481a0e347e34e4121bfef618f9d1079dee4c2445fb2fa975d55d311caf58014?apiKey=13afca4f450b492581b6852c1eaebe93&" class="feature-icon" alt="" />
                                    <p class="feature-text">Consolidate work from multiple teams without manual intervention
                                    </p>
                                 </div>
                              </div>
                              <div class="card-footer">
                                 Setup process in weeks instead of months
                              </div>
                           </div>
                        </div>
                        <div class="feature-column">
                           <div class="feature-card">
                              <div class="card-header">
                                 <img loading="lazy" src="https://www.prohance.net/new-lp/images/wf-banking-finance.png" class="header-image" alt="Banking and Insurance" />
                              </div>
                              <div class="card-content">
                                 <h3 class="card-title">Banking and Insurance</h3>
                                 <div class="feature-item">
                                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/c4f8299e3cf8f1a30d344ec90ef3d38154291222aecbd9e7a51e0f4c79fc6fee?apiKey=13afca4f450b492581b6852c1eaebe93&" class="feature-icon" alt="" />
                                    <p class="feature-text">Use API to get work from CRMs
                                    </p>
                                 </div>
                                 <div class="feature-item">
                                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/4481a0e347e34e4121bfef618f9d1079dee4c2445fb2fa975d55d311caf58014?apiKey=13afca4f450b492581b6852c1eaebe93&" class="feature-icon" alt="" />
                                    <p class="feature-text">Prioritize tasks based on loan amount, client, or insurance data
                                    </p>
                                 </div>
                                 <div class="feature-item">
                                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/4481a0e347e34e4121bfef618f9d1079dee4c2445fb2fa975d55d311caf58014?apiKey=13afca4f450b492581b6852c1eaebe93&" class="feature-icon" alt="" />
                                    <p class="feature-text">Create validated fields for ensure correct information
                                    </p>
                                 </div>
                                 <div class="feature-item">
                                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/4481a0e347e34e4121bfef618f9d1079dee4c2445fb2fa975d55d311caf58014?apiKey=13afca4f450b492581b6852c1eaebe93&" class="feature-icon" alt="" />
                                    <p class="feature-text">Create interlinked processes from origination to issuing loans
                                    </p>
                                 </div>
                              </div>
                              <div class="card-footer">
                                 Designed to work using low client resources
                              </div>
                           </div>
                        </div>
                        <div class="feature-column">
                           <div class="feature-card">
                              <div class="card-header">
                                 <img loading="lazy" src="https://www.prohance.net/new-lp/images/wf-hr-fin.png" class="header-image" alt="Human Resources and Finance" />
                              </div>
                              <div class="card-content">
                                 <h3 class="card-title">Human Resources and Finance</h3>
                                 <div class="feature-item">
                                    ...
                                    <p class="feature-text">Convert emails to tasks</p>
                                 </div>
                                 <div class="feature-item">
                                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/6219af6a5f00d89a100af20d859031d7c112fb54126021b5a73e365a049552a0?apiKey=13afca4f450b492581b6852c1eaebe93&" class="side-feature-icon" alt="" />
                                    <p class="feature-text">Automated task scheduler</p>
                                 </div>
                                 <div class="feature-item">
                                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/6219af6a5f00d89a100af20d859031d7c112fb54126021b5a73e365a049552a0?apiKey=13afca4f450b492581b6852c1eaebe93&" class="side-feature-icon" alt="" />
                                    <p class="feature-text">User web forms for creating tasks
                                    </p>
                                 </div>
                                 <div class="feature-item">
                                    ...
                                    <p class="feature-text">Real Time work status tracking</p>
                                 </div>
                              </div>
                              <div class="card-footer">
                                 Highly secure and robust platform
                              </div>
                           </div>
                        </div>
                     </div>
      ...
      <section class="casestudy-section">
         <h2 class="common-ttle text-center">CASE STUDY</h2>
         <h5 class="case-study-subtitle">In Patients Coding Process for Healthcare - 250 FTE</h5>
         <p>Improve Productivity - Ease of Tracking using Automated Rules</p>
         <div class="casestudy-container">
            <div class="business-challenge-container">
               <div class="header">
                  <img class="icon" src="https://www.prohance.net/new-lp/img/group-629309@2x.png" alt="Business Challenge Icon">
                  <div class="title montserrat-bold-white-24px">BUSINESS CHALLENGE</div>
               </div>
               <div class="content-row">
                  <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-34.svg" alt="Bullet Icon">
                  <p class="description lexend-medium-black-18px">
                     Business could not track production real-time<br>Targets are manually tracked using excel/emails<br>Multiple
                     quality issues - Tracking challenges<br>Cycle time is repeatedly missed
                  </p>
               </div>
               <div class="content-row">
                  <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-34.svg" alt="Bullet Icon">
                  <p class="description lexend-medium-black-18px">
                     Manual allocation - Prone to error, dependent on SME<br>TL spending 2 hours per day for managing
                     uploads<br>Tasks not assigned based on attendance<br>Only FIFO capability
                  </p>
               </div>
               <div class="content-row">
                  <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-34.svg" alt="Bullet Icon">
                  <p class="description lexend-medium-black-18px">
                     Unique tracking starts after pre underwriting tasks are processed - Full cycle time failure,
                     escalations, and revenue loss
                  </p>
               </div>
               <div class="content-row">
                  <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-34.svg" alt="Bullet Icon">
                  <p class="description lexend-medium-black-18px">
                     On hold tasks contribute 18% delays, causing revenue loss
                  </p>
               </div>
            </div>
            <div class="approach-improvements-container">
               <div class="approach-container">
                  <div class="header">
                     <img class="icon" src="https://www.prohance.net/new-lp/img/group-629310@2x.png" alt="Approach Icon">
                     <div class="title montserrat-bold-white-24px">APPROACH USED</div>
                  </div>
                  <div class="content-row">
                     <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-28.svg" alt="Bullet Icon">
                     <p class="description lexend-medium-black-18px">
                        Business automated rules on ProHance, reducing time to upload work
                     </p>
                  </div>
                  <div class="content-row">
                     <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-28.svg" alt="Bullet Icon">
                     <p class="description lexend-medium-black-18px">
                        3 hours saved per TL as Agent scorecard is automated
                     </p>
                  </div>
                  <div class="content-row">
                     <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-28.svg" alt="Bullet Icon">
                     <p class="description lexend-medium-black-18px">100% adoption - 200+ users doing production</p>
                  </div>
                  <div class="content-row">
                     <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-28.svg" alt="Bullet Icon">
                     <p class="description lexend-medium-black-18px">
                        Full digital tracking - Real Time statistics<br>Completed, AHT, Last logged, Idle time<br>Work
                        from anywhere
                     </p>
                  </div>
                  <div class="content-row">
                  ...
                  <div class="content-row">
                     <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-28.svg" alt="Bullet Icon">
                     <p class="description lexend-medium-black-18px">
                        AHT data being baselined for analysis
                     </p>
                  </div>
               </div>
               <div class="improvements-container" style="margin-top:25px;">
                  <div class="header">
                     <img class="icon" src="https://www.prohance.net/new-lp/img/group-629310@2x.png" alt="Improvements Icon">
                     <div class="title montserrat-bold-white-24px">IMPROVEMENTS</div>
                  </div>
                  <div class="content-row">
                     <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-38.svg" alt="Bullet Icon">
                     <p class="description lexend-medium-black-18px">
                        <span class="highlight">Cycle time reduction by </span><span class="highlight-bold">15%</span>
                     </p>
                  </div>
                  <div class="content-row">
                     <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-38.svg" alt="Bullet Icon">
                     <p class="description lexend-medium-black-18px">
                        <span>On hold TAT reduction by 12 hrs,</span><span class="highlight">20% reduction</span> in volume
                     </p>
                  </div>
                  <div class="content-row">
                     <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-38.svg" alt="Bullet Icon">
                     <p class="description lexend-medium-black-18px">
                        Email Adaptor automatically reads emails and creates digital requests
                     </p>
                  </div>
                  <div class="content-row">
                     <img class="bullet-icon" src="https://www.prohance.net/new-lp/img/vector-38.svg" alt="Bullet Icon">
                     <p class="description lexend-medium-black-18px">
                        Two-stage processing allows unique identification from first time requests
                     </p>
                  </div>
               </div>
            </div>
      ...
      <section class="casestudy-section common-pd-tb">
         <h2 class="common-ttle text-center">CASE STUDY</h2>
         <h5 class="case-study-subtitle">Improve Cycle Time Benefits for Loan Originations Process</h5>
         <div class="casestudy-container">
            <img class="img-fluid" src="https://www.prohance.net/new-lp/img/casestudy-graph-wf-lp.png" alt="casestudy  Graph ">
         </div>
      </section>

<?php 
//define("NITROPACK_HOME_URL", "prohance.ai"); 
...
<meta name="google-site-verification" content="gJev2NQ_1ZPt2dLTSMg5NVlgRW8xhG8fryACHN7IIhI" />
<!-- Google tag (gtag.js) -->
...
if (curPageName() == "index") {
    if (getCurrentPageURL('url') == "https://www.prohance.ai/glossary/") {
        ...
        $title = "ProHance: Workforce Analytics & Productivity Measurement Tool";
        $description = "Workforce analytics and productivity measurement tools in workforce management software can optimize your business operations. Get insights & improve productivity today.";
    ...
    $keywords = "";
} else if (curPageName() == "how-habits-shape-corporate-identity") {
    $title = "How Habits Shape Corporate Identity | ProHance";
    $description = "Learn how building positive habits within an organization shapes corporate identity, boosts culture, and drives long-term success in the workplace.";
    $keywords = "";
} else if (curPageName() == "building-good-habits-for-organisations") {
    $title = "How to Make Good Habits Obvious in Organizations | ProHance";
    $description = "Learn how building good habits within organizations can enhance productivity, foster a positive culture & drive long-term success through consistent improvement.";
    $keywords = "";
} else if (curPageName() == "productivity-hub") {
    $title = "Enhance Productivity with Powerful Insights & Strategies | ProHance";
    $description = "Leverage powerful strategies and insights to boost your productivity and achieve your goals effectively with ProHance's productivity solutions.";
    $keywords = "";
} else if (curPageName() == "why-tiny-changes-make-a-big-difference") {
    $title = "Why Tiny Changes Make a Big Difference | ProHance";
    $description = "Learn how small, consistent changes in your approach can lead to significant improvements in productivity, efficiency, and overall success in the workplace.";
    $keywords = "";
    ...
    $keywords = "";
} else if (curPageName() == "book-a-demo") {
    $title = "ProHance: Book a Demo";
    $description = "Get a ProHance Demo with a Product Specialist now. Get real-time visibilty of your workforce with customized reports and get actionable insights.";
    $keywords = "";
...
} else if (curPageName() == "prohance-rcm-whitepaper") {
    $title = "Workforce Analytics: A Key Lever for RCM Success | ProHance";
    $description = "Leverage workforce analytics to optimize RCM processes, improve efficiency, reduce cos & achieve sustainable success in revenue cycle management.";
    $keywords = "";
...
with a focus on hybrid work and productivity.";
    ...
    $title = "Webinars & Conferences on Workforce Optimization | ProHance Events";
    $description = "Stay ahead with ProHance Events! Join our expert-led webinars, conferences, industry discussions on workforce analytics, productivity, and automation.";
    $keywords = "";
    ...
    $description = "View the complete sitemap of ProHance to easily navigate through all our pages, including solutions, blogs & resources for enhancing workforce efficiency";
    ...
    $keywords = "";
} else if (curPageName() == "prohance-ai-retention-risk-index-whitepaper") {
    $title = "ProHance AI Retention Risk Index | Precision Meets Probability";
    $description = "Read the ProHance AI Retention Risk Index whitepaper to learn how AI helps predict and address employee retention risks for better workforce management.";
    $keywords = "";
    ...
    $title = "Global Productivity Benchmarking Report | Prohance";
    $description = "Get insights from Global Productivity Benchmarking Report to improve efficiency and performance across industries with data-driven strategies & key metrics.";
    $keywords = "";
    ...
    else if(strpos(getCurrentPageURL('url'), 'industry-solutions/bfsi-workforce-utilization-and-compliance.php') !== false){
    $title = "BFSI Workflow automation & Compliance Monitoring | ProHance";
    $description = "Boost workforce efficiency with ProHance’s BFSI workflow platform. Ensure compliance and automate underwriting operations. Try now for smart workforce monitoring!";
    $keywords = "";
} 
    else if(strpos(getCurrentPageURL('url'), 'industry-solutions/bpo-sla-compliance-and-productivity.php') !== false){
    $title = "Call Center Workforce Management Software | ProHanceCX";
    $description = "Workforce forceasting, scheduling and capacity planning to ensure SLA compliance with ProhanceCX workforce analytics. Control attriiton of your BPO teams.";
    $keywords = "";
} 
    else if(strpos(getCurrentPageURL('url'), 'industry-solutions/gcc-workforce-productivity.php') !== false){
    $title = "Boost GCC Workforce Productivity | ProHance";
    $description = "Improve your backoffice workforce productivity, gain real-time insights and take data-driven decisions. Try ProHance now!";
    $keywords = "";
} 
    else if(strpos(getCurrentPageURL('url'), 'industry-solutions/healthcare-rcm-operational-visibility.php') !== false){
    $title = "Healthcare Workflow Automation and Compliance Management | ProHance";
    $description = "Streamline RCM, automate medical coding and track tasks with ProHance’s healthcare workforce automation platform. Improve efficiency & compliance with ProHance now!";
    $keywords = "";
} 
    else if(strpos(getCurrentPageURL('url'), 'industry-solutions/it-ites-productivity-tracking.php') !== false){
    $title = "Productivity and project management software for IT Developers | ProHance";
    $description = "Track software development projects in real-time and boost devops productivity with ProHance. Use developer productivity analytics and time tracking software for developers today!";
    $keywords = "";
} 
//     else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-project-tracking.php') !== false){
//     $title = "What Is Project Tracking? A Complete Guide";
//     $description = "Find the details about Project Tracking and how it helps improve business processes and employee productivity";
//     $keywords = "";
// } 
//     else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-project-scheduling.php') !== false){
//     $title = "What is Project Scheduling?  | Prohance";
//     $description = "Effective project scheduling enables teams to align with realistic timelines and milestones. Discover how ProHance simplifies scheduling in project management.";
//     $keywords = "";
// } 
//     else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-human-capital-management.php') !== false){
//     $title = "What is human capital management (HCM)? | Prohance";
//     $description = "Learn about  Human Capital Management (HCM), It’s processes, tools to hire, manage, and boost workforce productivity. Learn how HCM supports business growth.";
//     $keywords = "";
// }
//     else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-saas.php') !== false){
//     $title = "What Is Software as a Service (SaaS)? | Definition, Benefits & Challenges";
//     $description = "Know what is Software as a Service (SaaS), how it works, and its business benefits. Learn how ProHance uses SaaS to boost productivity.";
//     $keywords = "";
// }
//     else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-work-breakdown-structure.php') !== false){
//     $title = "What Is a Work Breakdown Structure (WBS)? A Complete Guide";
//     $description = "Find what a Work Breakdown Structure (WBS) is, why it’s essential for project planning, and how to create one to break down tasks, improve clarity, and boost team efficiency.";
//     $keywords = "";
// }
    ...
    $keywords = "";
    //echo getCurrentPageURL('url');
   // echo "firstteststes";
}


else if(strpos(getCurrentPageURL('url'), 'glossary/intelligent-capacity-planning.php') !== false){
    $title = "Intelligent Capacity Planning — Definition, Components & Benefits | ProHance";
    $description = "Find intelligent capacity planning: learn how forecasting, resource allocation & scenario planning optimize operations, reduce costs, and scale effectively with ProHance.";
    $keywords = "";
}
// else if(strpos(getCurrentPageURL('url'), 'glossary/waht-is-overwork-detection.php') !== false){
//     $title = "What Are Manual Reports? Definition, Process & Pros | ProHance";
//     $description = "Learn what manual reports are, how they work, and their pros & cons. Understand the process and improve reporting accuracy. Visit ProHance to know more.";
//     $keywords = "";
// } 
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-employee-attendance.php') !== false){
//     $title = "What Is Attendance in the Workplace? | Staff Tracking by ProHance";
//     $description = "Learn what employee attendance means, why it's crucial, and how tracking it boosts staff productivity. Manage workplace attendance better with ProHance today.";
//     $keywords = "";
// } 
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-activity-report.php') !== false){
//     $title = "What Is an Activity Report? Format, Benefits & Tool | ProHance";
//     $description = "Learn what an activity report is, its key components, and format. Use ProHance’s activity reporting tool to track progress and improve decision-making. Start now!";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-business-performance.php') !== false){
//     $title = "What is Business Performance Management? | Prohance";
//     $description = "Understand the definition of business performance, key metrics & strategies to manage it effectively. Learn how Prohance supports better business outcomes today.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-work-measurement.php') !== false){
//     $title = "What Is Work Measurement? Definition, Methods & Importance | ProHance";
//     $description = "Learn what work measurement means, how it's defined, and the methods used. Improve task efficiency & resource planning with ProHance. Read the full guide now!";
//     $keywords = "";
// } 
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-efficiency-management.php') !== false){
//     $title = "What Is Efficiency in Management? Meaning, Definition | ProHance";
//     $description = "Learn what efficiency means in business & management. Understand key strategies, challenges & KPIs. Boost productivity with ProHance. Start optimizing today!";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-fto-full-time-in-office.php') !== false){
//     $title = "What Is FTO in Work? Meaning, Pros & Cons | ProHance";
//     $description = "Learn what FTO (Full Time in Office) means in corporate work culture. Understand its pros, cons & impact. Read now on ProHance to make informed workplace decisions.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-employee-behavior.php') !== false){
//     $title = "What Is Employee Behavior? Types & Examples | ProHance";
//     $description = "Learn what employee behavior means, its types, and why it matters. Understand productive behavior and improve workplace performance. Read on with ProHance.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-digital-solutions.php') !== false){
//     $title = "What Is Digital Solutions? Meaning & Benefits for Professionals | Prohance";
//     $description = "Learn what digital solutions mean for professionals & businesses. Improve workflows, boost efficiency, and drive growth with tech-driven tools. Get started today.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-core-vs-non-core-activities.php') !== false){
//     $title = "Core vs Non-Core Activities: Meaning, Differences & Key Insights";
//     $description = "Understand the difference between core and non-core activities. Learn how identifying them helps optimize operations. Read now to streamline business strategy with ProHance.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-project-tracking.php') !== false){
//     $title = "What Is Project Tracking? System, Methods & Benefits | ProHance";
//     $description = "Understand what project tracking is, how it works, and why it matters. Learn proven methods to track projects effectively with ProHance. Start improving results today.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-activity-type.php') !== false){
//     $title = "What Is Activity Type? Meaning, Categories & Importance | ProHance";
//     $description = "Learn what activity type means, its categories, and why it matters. Understand types of activity to improve task clarity, team performance & resource planning.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-non-productive-time.php') !== false){
//     $title = "What Is Non Productive Time & How to Reduce It | ProHance";
//     $description = "Understand what non productive time means, its causes, types & impact. Learn how to reduce non productive hours to boost efficiency. Visit ProHance for insights.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-cost-of-delivery.php') !== false){
//     $title = "Cost of Delivery: Meaning, Components & Optimization | ProHance";
//     $description = "Understand the cost of service delivery, its key components, and how to optimize it. Learn how ProHance enables cost-effective delivery management. Learn more now!";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-turn-around-time.php') !== false){
//     $title = "What Is Turn Around Time? Meaning, Importance & Benefits | Prohance";
//     $description = "Learn what turn around time means, why it matters, and how it boosts efficiency. Understand key factors & improve your TAT with expert insights. Start optimizing now!";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-quadrant-analysis.php') !== false){
//     $title = "what is Quadrant Analysis in Business: Meaning, Uses & Key Factors | Prohance";
//     $description = "Learn what quadrant analysis means, how it's used in business, and what factors influence product quadrants. Understand insights that drive smarter decisions today.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-work-distribution.php') !== false){
//     $title = "What Is Work Distribution? Meaning, Benefits & Tips | ProHance";
//     $description = "Learn what work distribution means and how to manage tasks efficiently. Improve team productivity and accountability with the right task distribution approach.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-center-of-excellence.php') !== false){
//     $title = "What Is a Center of Excellence (CoE)? Meaning, Types & Benefits | Prohance";
//     $description = "Learn what a Center of Excellence (CoE) means, its types & business benefits. Define your CoE strategy today with Prohance to improve innovation & performance.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-task-allocation.php') !== false){
//     $title = "What Is Task Allocation in Project Management? | ProHance";
//     $description = "Understand task allocation meaning, examples, and strategies. Learn how to optimize task distribution in projects. Boost productivity with ProHance. Read now!";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-global-process-owner.php') !== false){
//     $title = "What is a Global Process Owner? Role & Importance | Prohance";
//     $description = "Learn the role of a Global Process Owner, key responsibilities, and how it drives process efficiency. Understand the business process owner definition. Read now.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-executive-management.php') !== false){
//     $title = "What is a Global Process Owner? Role & Importance | Prohance";
//     $description = "Learn the role of a Global Process Owner, key responsibilities, and how it drives process efficiency. Understand the business process owner definition. Read now.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-man-days.php') !== false){
//     $title = "Mandays Meaning: What Is Man Days in Project Planning | ProHance";
//     $description = "Learn what mandays mean and how they impact project planning, budgeting & resource allocation. Understand it better with ProHance. Start improving productivity now!";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-in-person-work.php') !== false){
//     $title = "What Is In-Person Work? Meaning, Benefits & Challenges | ProHance";
//     $description = "Learn what in-person work means, its pros, cons, and how it compares to remote setups. Understand your work location better and make informed job decisions today.";
//     $keywords = "";
// }
// else if(strpos(getCurrentPageURL('url'), 'glossary/what-is-skills-development.php') !== false){
//     $title = "What Is Skill Development? Definition, Strategies & Key Components";
//     $description = "Learn what skill development means, its benefits, and how to build technical and soft skills. Improve your growth with practical tips. Start enhancing your skills now!";
//     $keywords = "";
// }
  else if(strpos(getCurrentPageURL('url'), 'ai-adoption-visibility.php') !== false){
    $title = "Measure & enhance AI Adoption in your business| ProHance";
    $description = "Gain real-time insights into AI tool usage to enhance AI adoption in your workforce. Measure ROI of AI tools and boost workforce productivity with ProHance.";
    $keywords = "";
}   else if(strpos(getCurrentPageURL('url'), 'asset-optimization.php') !== false){
    $title = "IT Asset Optimization & Management Software | ProHance";
    $description = "Track, manage, and optimize IT assets with ProHance. Improve compliance, reduce risk, and enhance utilization with real-time insights and automation.";
    $keywords = "";
}   else if(strpos(getCurrentPageURL('url'), 'cost-of-delivery-optimization.php') !== false){
    $title = "Workforce Cost Optimization Software | ProHance";
    $description = "Cut delivery costs with ProHance. Gain real-time workforce insights to reduce inefficiencies, track productivity, and optimize operations at scale.";
    $keywords = "";
}  else if(strpos(getCurrentPageURL('url'), 'distributed-process-management.php') !== false){
    $title = "No-Code Workflow & Process Management Software | ProHance";
    $description = "Automate task allocation, simplify process management, and improve visibility with ProHance’s no-code workflow management software for teams.";
    $keywords = "";
}  else if(strpos(getCurrentPageURL('url'), 'employee-disengagement-and-retention-risk.php') !== false){
    $title = "AI-Powered Employee disengagement and Retention Insights | ProHance";
    $description = "Use ProHance's AI-powered analytics to detect disengagement early, lower attrition risks, and improve employee retention with data-driven workforce insights.";
    $keywords = "";
}   else if(strpos(getCurrentPageURL('url'), 'hybrid-workforce-management.php') !== false){
    $title = "Hybrid and Remote Workforce Management Software | ProHance";
    $description = "Prohance offers workforce management analytics, and insights to enhance productivity, optimize performance, and manage remote & hybrid teams effectively.";
    $keywords = "";
}   else if(strpos(getCurrentPageURL('url'), 'partner-ecosystem-management.php') !== false){
    $title = "Vendor and contingent workforce management| ProHance";
    $description = "ProHance's Partner Ecosystem Management software streamlines contingent workforce management, improving visibility, efficiency, and vendor performance.";
    $keywords = "";
}   
  else {
...
<?php if($keywords):?><meta content="<?php echo $keywords; ?>" name="keywords"><?php endif; ?>
...
<?php if(getCurrentPageURL('url')!="https://www.prohance.ai/glossary/"){ ?>
<script type="application/ld+json">
{
  "@context": "https://schema.org/",
  "@type": "WebSite",
  "name": "Prohance",
  "url": "https://www.prohance.ai/",
  "potentialAction": {
    "@type": "SearchAction",
    "target": "https://www.prohance.ai/search.php?s={search_term_string}",
...
<script type="application/ld+json">
{
  ...
  "url": "https://www.prohance.ai/",
  "logo": "https://www.prohance.ai/images/ProHance-logo.png",
  "address":
  [
    {
    "@type": "PostalAddress",
